...
const stockShortages: SyncTable<StockShortage> = {
  ...
  toRow: (shortage) => ({
    ...
    reference: shortage.reference ?? null,
    location: shortage.location ?? null,
    label: shortage.label ?? null,
    note: shortage.note ?? null,
  ...
  fromRow: (row) => ({
    ...
    reference: undef(row.reference as string | null),
    location: undef(row.location as string | null),
    label: undef(row.label as string | null),
    note: undef(row.note as string | null),
